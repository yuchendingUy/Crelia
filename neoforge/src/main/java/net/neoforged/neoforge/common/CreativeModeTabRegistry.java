...
public final class CreativeModeTabRegistry {
    ...
    public static void sortTabs() {
        ...
        DEFAULT_TABS.add(BuiltInRegistries.CREATIVE_MODE_TAB.get(vanillaTab("hotbar")));
        DEFAULT_TABS.add(BuiltInRegistries.CREATIVE_MODE_TAB.get(vanillaTab("search")));
        DEFAULT_TABS.add(BuiltInRegistries.CREATIVE_MODE_TAB.get(vanillaTab("op_blocks")));
        DEFAULT_TABS.add(BuiltInRegistries.CREATIVE_MODE_TAB.get(vanillaTab("inventory")));
